...
var app = angular.module('AngularSFDemo', ['AngularForce', 'AngularForceObjectFactory', 'Contact', 'ui.bootstrap']);
...
app.config(function ($routeProvider) {
    $routeProvider.
     when('/admin', {controller: AdminCtrl, templateUrl: 'partials/login.html'}).
        ...
        when('/orgchart', {controller: OrgChartCtrl, templateUrl: 'partials/contact/list.html'}).
